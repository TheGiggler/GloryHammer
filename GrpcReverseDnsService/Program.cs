...
using ReverseDns;
using GrpcReverseDns.gRPC;

namespace GrpcReverseDnsService
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
           // endpointToTest = args[0];
            ...
            {
                Services = { ReverseDnsService.BindService(new GrpcServerImpl(settings)) },
            ...
            Console.WriteLine("GrpcReverseDnsService listening on port " + settings.ListenPort);
